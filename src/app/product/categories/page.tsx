            ...
            <section className="relative pt-32 pb-20 overflow-hidden bg-[var(--muted)]">
                <div className="container-app relative z-10">
                    <div className="max-w-3xl mx-auto text-center">
                        <h1 className="text-4xl md:text-5xl font-bold mb-6">Explore <span className="text-gradient">Categories</span></h1>
                        <p className="text-lg text-[var(--muted-foreground)] mb-8">
                            Discover unique artworks across a wide range of mediums, styles, and traditions.
                        ...
                        <div className="relative max-w-xl mx-auto">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-10 py-4 rounded-xl border border-[var(--border)] bg-[var(--background)] shadow-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary-500)]"
                            />
                            {searchQuery && (
                                <button
                ...
                {/* Background Elements */}
                <div className="absolute top-20 left-[-5%] w-64 h-64 rounded-full bg-[var(--primary-200)] blur-3xl opacity-30 pointer-events-none" />
                <div className="absolute bottom-10 right-[-5%] w-80 h-80 rounded-full bg-[var(--secondary-200)] blur-3xl opacity-30 pointer-events-none" />
            </section>
            ...
            <section className="py-20">
                <div className="container-app">
                    {filteredCategories.length > 0 ? (
                        ...
                        <div className="text-center py-20 bg-[var(--muted)]/30 rounded-3xl border border-dashed border-[var(--border)]">
